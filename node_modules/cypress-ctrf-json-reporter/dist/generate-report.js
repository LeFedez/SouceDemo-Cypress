...
class GenerateCtrfReport {
    constructor(reporterOptions) {
        ...
        this.reporterConfigOptions = {
            ...
            screenshot: (_d = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.screenshot) !== null && _d !== void 0 ? _d : false,
            testType: (_e = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.testType) !== null && _e !== void 0 ? _e : 'e2e',
            appName: (_f = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.appName) !== null && _f !== void 0 ? _f : undefined,
            appVersion: (_g = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.appVersion) !== null && _g !== void 0 ? _g : undefined,
            osPlatform: (_h = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.osPlatform) !== null && _h !== void 0 ? _h : undefined,
            osRelease: (_j = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.osRelease) !== null && _j !== void 0 ? _j : undefined,
            osVersion: (_k = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.osVersion) !== null && _k !== void 0 ? _k : undefined,
            buildName: (_l = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.buildName) !== null && _l !== void 0 ? _l : undefined,
            buildNumber: (_m = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.buildNumber) !== null && _m !== void 0 ? _m : undefined,
            buildUrl: (_o = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.buildUrl) !== null && _o !== void 0 ? _o : undefined,
            repositoryName: (_p = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.repositoryName) !== null && _p !== void 0 ? _p : undefined,
            repositoryUrl: (_q = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.repositoryUrl) !== null && _q !== void 0 ? _q : undefined,
            branchName: (_r = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.branchName) !== null && _r !== void 0 ? _r : undefined,
            testEnvironment: (_s = reporterOptions === null || reporterOptions === void 0 ? void 0 : reporterOptions.testEnvironment) !== null && _s !== void 0 ? _s : undefined,
        };
        this.ctrfReport = {
            results: {
                tool: {
        ...
        if (((_t = this.reporterConfigOptions) === null || _t === void 0 ? void 0 : _t.outputFile) !== undefined)
            this.setFilename(this.reporterConfigOptions.outputFile);
        if (!fs.existsSync((_u = this.reporterConfigOptions.outputDir) !== null && _u !== void 0 ? _u : this.defaultOutputDir)) {
            fs.mkdirSync((_v = this.reporterConfigOptions.outputDir) !== null && _v !== void 0 ? _v : this.defaultOutputDir, { recursive: true });
        }
    ...
    getScreenshot(test, results, returnAttachmentObjects = false) {
        if (this.reporterConfigOptions.screenshot === false &&
        ...
        const testScreenshots = results.screenshots.filter((screenshot) => screenshot.path !== undefined &&
            screenshot.path !== '' &&
        ...
        let matchingScreenshot = testScreenshots.find((screenshot) => screenshot.path.includes('(failed)'));
        ...
        if (matchingScreenshot !== undefined) {
            try {
                ...
                console.warn(`Error reading screenshot file ${matchingScreenshot.path}:`, error);
                return undefined;
            }
        }
        return undefined;
    }
    getAttachments(test, results) {
        const attachments = [];
        if (results.screenshots !== undefined && results.screenshots.length > 0) {
            try {
